...
def policy_iteration(D, S_max, theta, phi, Z_max, alpha, tau, lmbda, beta, threshold, Kmin):
    ...
    while not converged:
        ...
        while True:
            ...
            for i in range(len(states)):
                ...
                V_new[i] = reward + beta * expected_future_value
            ...
            if evaluation_iteration >= Kmin and delta < threshold:
                break
